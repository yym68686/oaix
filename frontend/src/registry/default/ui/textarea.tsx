    ...
    >
      <FieldPrimitive.Control
        ...
        render={(defaultProps: React.ComponentProps<"textarea">) => (
          <textarea
            className={cn(
              "min-h-17.5 w-full min-w-0 max-w-full resize-y overflow-x-auto rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-none [field-sizing:fixed] [overflow-wrap:anywhere] max-sm:min-h-20.5",
              size === "sm" &&
